...
FrameGen_I*  ChannelConvert_getFrameGen(PluginData_T);
PluginData_T ChannelConvert_init(FrameGen_T*);

void
PostInputPlugin_Info(PostInputPlugin_T *p)
{
    p->name        = name;
    p->revision    = revision;
    p->getFrameGen = ChannelConvert_getFrameGen;
    p->init        = ChannelConvert_init;
}

FrameGen_I*
ChannelConvert_getFrameGen(PluginData_T data)
{
    return NULL;
}

PluginData_T
ChannelConvert_init(FrameGen_T* input)
{
    return NULL;
}
